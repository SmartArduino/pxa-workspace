...
int main(void) {
...

    {
        ...
        assert(backend.raster_upload(backend.context, surface, upload,
        ...
        assert(backend.raster_submit(backend.context, surface, draw,
        ...
        assert(backend.raster_query(backend.context, surface, &telemetry) ==
                   PXA_STATUS_OK &&
