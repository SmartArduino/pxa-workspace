...
// SenseCAP Watcher speaker path: ES8311 DAC over I2S0 at 16 kHz mono. The
// class also registers itself as the PXA host audio sink so Guest PCM frames
// are written straight to the codec.
class WatcherAudio {
public:
